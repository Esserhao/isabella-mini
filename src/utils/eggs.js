...
export const EGGS = [
    ...
    { key: 'perfect',      name: '主题正解', desc: '在挑战模式下，拿下 95 分的满分契合度封存当日挑战——这套评分永远给明天留 5 分。' },
    ...
    // 「写满字」系列：封存时的名字 / 感言输入框都有字数上限，写满即达成（lab.vue 封存时判）。
    { key: 'full_name',    name: '名号拉满',   desc: '给这瓶香起了 8 个字的名字——上限写满，一个字都不肯省。' },
    { key: 'full_note',    name: '一字不剩',   desc: '调香感言写满了 20 个字的上限。话都说到这份上了，一定很好闻。' },
    { key: 'full_both',    name: '言尽其香',   desc: '名字 8 字、感言 20 字，全部写到上限。这瓶香的故事，一点没留白。' }
];
